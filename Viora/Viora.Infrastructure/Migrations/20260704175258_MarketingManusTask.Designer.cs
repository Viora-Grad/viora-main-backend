...
namespace Viora.Infrastructure.Migrations
{
    ...
    [Migration("20260704175258_MarketingManusTask")]
    partial class MarketingManusTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Viora.Domain.Marketing.MarketingChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MarketingChatMessages", (string)null);
                });
            ...
            modelBuilder.Entity("Viora.Domain.Marketing.MarketingChatSession", b =>
                {
                    ...
                    b.Property<string>("LatestManusIdea")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("PendingManusTaskId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("PendingManusTaskUrl")
                        .HasMaxLength(500)
                    ...
                    b.ToTable("MarketingChatSessions", (string)null);
                });

            modelBuilder.Entity("Viora.Domain.Marketing.MetaPageCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MetaPageCredentials", (string)null);
                });
            ...
            modelBuilder.Entity("Viora.Domain.Prescriptions.Prescription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Viora.Domain.Prescriptions.PrescriptionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Dosage", "Viora.Domain.Prescriptions.PrescriptionItem.Dosage#MedicalDosage", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Name", "Viora.Domain.Prescriptions.PrescriptionItem.Name#MedicationName", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Note", "Viora.Domain.Prescriptions.PrescriptionItem.Note#PrescriptionNote", b1 =>
                        {
                            b1.Property<string>("Value")
                                .IsRequired()
                                .HasMaxLength(200)
            ...
            modelBuilder.Entity("Viora.Domain.Prescriptions.PrescriptionTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("TemplateMediaId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<double>("TopMargin")
                        .HasColumnType("float");

                    b.ComplexProperty(typeof(Dictionary<string, object>), "Name", "Viora.Domain.Prescriptions.PrescriptionTemplate.Name#TemplateName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Viora.Domain.Marketing.MarketingChatMessage", b =>
                {
                    b.HasOne("Viora.Domain.Marketing.MarketingChatSession", null)
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Viora.Domain.Prescriptions.Prescription", b =>
                {
                    b.HasOne("Viora.Domain.Appointments.Appointment", null)
                        .WithOne()
                        .HasForeignKey("Viora.Domain.Prescriptions.Prescription", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Viora.Domain.Prescriptions.PrescriptionItem", b =>
                {
                    b.HasOne("Viora.Domain.Prescriptions.Prescription", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Viora.Domain.Prescriptions.PrescriptionTemplate", b =>
                {
                    b.HasOne("Viora.Domain.Medias.MediaFile", "File")
                        .WithOne()
                        .HasForeignKey("Viora.Domain.Prescriptions.PrescriptionTemplate", "TemplateMediaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
