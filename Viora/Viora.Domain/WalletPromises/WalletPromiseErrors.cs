...
public static class WalletPromiseErrors
{
    ...
    public static readonly Error InvalidExpirationTime = new("WalletPromises.InvalidExpirationTime", "Expiry can not be less than current date", ErrorCategory.Conflict);
}
